  ...
  <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
        ...
        <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white text-sm">C#, ASP.NET, MVC, Razor, JavaScript, React.js, AL Language</p>
          </div>
        </div>
        <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
        ...
        <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white text-sm">Git, Bitbucket, Git Extension, Visual Studio, Postman, Windows Task Scheduler, Jira, Azure DevOps, Docker</p>
          </div>
        </div>
        <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white text-sm">Microsoft Dynamics 365 Business Central, Dynamicweb CMS</p>
          </div>
        </div>
        <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
          <Repeat className="w-8 h-8 text-primary-pink mt-1" />
