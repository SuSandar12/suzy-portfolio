...
export default function Skills() {
  return (
    <section id="skills" className="max-w-6xl mx-auto py-12 px-4">
      <h2 className="text-3xl font-bold text-primary-pink mb-8 text-center">
        Core Skills
      </h2>
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-primary-pink mb-1">
                Requirement Gathering & Analysis
              </h3>
              <p className="text-white text-sm">
                Documenting requirements, translating into technical specs
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                C#, ASP.NET, MVC, Razor, JavaScript, React.js, AL Language
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                HTML5, CSS3, JavaScript, Ajax, jQuery, Bootstrap, Tailwind
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                RESTful APIs, Entity Framework, Windows Forms
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
          ...
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                Git, Bitbucket, Git Extension, Visual Studio, Postman, Windows
                Task Scheduler, Jira, Azure DevOps, Docker
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                Microsoft Dynamics 365 Business Central, Dynamicweb CMS
              </p>
            </div>
          </div>
          <div className="bg-black rounded-xl shadow p-6 flex items-start gap-4">
