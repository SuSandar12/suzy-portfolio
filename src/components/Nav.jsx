  ...
  return (
    <nav className="bg-black shadow-md fixed w-full top-0 left-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <div className="text-xl font-bold text-primary-pink cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Suzy's Portfolio</div>
        <ul className="flex space-x-6 hidden md:flex">
          <li>
           ...
           <li>
            <a href="#education" className="text-gray-700 hover:text-pink-600 font-medium">Education</a>
          </li>
          <li>
