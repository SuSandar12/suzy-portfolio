...
const activities = [
  ...
  },
  {
    ...
    images: [
      "/suzy-portfolio/images/innoserve1.jpg",
      "/suzy-portfolio/images/innoserve2.jpg",
    ],
  ...
  },
  {
    ...
    images: [
      "/suzy-portfolio/images/hackathon1.jpg",
      "/suzy-portfolio/images/hackathon2.jpg",
    ],
...
export default function Activities() {
  ...
  return (
    <FadeInSection>
      <section id="activities" className="max-w-6xl mx-auto py-12 px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-primary-pink">
          Activities
        </h2>
